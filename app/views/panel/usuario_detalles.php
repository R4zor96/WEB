<?php
    ...
    require_once '../../models/Tabla_roles.php';
    ...
    $roles = $tabla_roles->readAllRoles();
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <?= mostrar_menu_lateral($_SESSION, "USUARIOS") ?>
                    </ul>
                </nav>
                <!-- /.sidebar-menu -->
            </div>
                                                    ...
                                                    <?php
                                                        if(!empty($roles)){
                                                            foreach($roles as $rol){
                                                                echo '<option value="'.$rol->id_rol.'" '.(($usuario->id_rol == $rol->id_rol) ? "selected" : "").'>'.$rol->rol.'</option>';
                                                            }//end foreach
                                                        }//end if
                                                    ?>
